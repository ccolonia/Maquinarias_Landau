...
export default function ProductosPage() {
  ...
  function openEditDialog(product: Product) {
    ...
    // Parsear características: puede ser JSON array o texto plano
    let featuresText = product.features
    try {
  ...
  async function handleSave() {
    ...
    setSaving(true)
    try {
      // Convertir características de texto plano a JSON array
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {filteredProducts.map(product => (
          <Card key={product.id} className={`bg-white border border-gray-100 overflow-hidden ${!product.active ? 'opacity-60' : ''}`}>
              ...
              <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-100">
                <div className="flex gap-2">
                  <Button 
                    ...
                    className="border-gray-300 text-gray-700 hover:bg-blue-100 hover:text-blue-700 hover:border-blue-300"
                  >
                  ...
                  <Button 
                    ...
                    className={product.active ? "border-gray-300 text-gray-700 hover:bg-green-100 hover:text-green-700 hover:border-green-300" : "border-gray-300 text-gray-700 hover:bg-gray-200 hover:text-gray-700"}
                  >
                  ...
                  <Button 
                    ...
                    className="border-gray-300 text-gray-700 hover:bg-red-100 hover:text-red-700 hover:border-red-300"
                  >
