...
const navigation = [
  ...
  { name: 'Agente de Voz', href: '/admin/agente-voz', icon: Mic },
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className={cn(
        ...
        <div className="flex-shrink-0 p-4 border-t border-gray-200 bg-white space-y-2">
          <Link
            href="/"
            className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-all cursor-pointer"
          >
          ...
          <button
            ...
            disabled={loggingOut}
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50 hover:text-red-700 transition-all cursor-pointer"
          >
            {loggingOut ? (
