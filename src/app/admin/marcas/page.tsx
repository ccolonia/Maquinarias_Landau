  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {brands.map(brand => (
          <Card key={brand.id} className={`bg-white border border-gray-100 ${!brand.active ? 'opacity-60' : ''}`}>
            <CardContent className="p-6">
              ...
              {brand.description && (
                <p className="text-sm text-gray-500 mt-4 line-clamp-2">{brand.description}</p>
              )}
